...
3. 修正語法但保持原意
4. 適當加入標點符號，中文內容必須使用全形標點（，、。！？：；「」『』（）——……），絕對不可使用半形標點
5. 如果內容明顯是清單、步驟或列舉項目，請以條列式呈現（用 • 符號或 1. 2. 3. 編號）；一般口語內容則整理為連貫段落
6. 不要添加原文沒有的內容
7. 所有中文必須使用繁體中文，絕對不可輸出簡體中文
只輸出整理後的文字，不要加任何解釋。";
...
2. 如果說話者中途改口，只保留最終的意思
3. 修正語法但保持原意和原本的語言選擇
4. 適當加入標點符號，中文部分必須使用全形標點（，、。！？：；「」『』（）——……），絕對不可使用半形標點
5. 如果內容明顯是清單、步驟或列舉項目，請以條列式呈現（用 • 符號或 1. 2. 3. 編號）；一般口語內容則整理為連貫段落
6. 不要把外語強制翻譯成中文
7. 所有中文部分必須使用繁體中文，絕對不可輸出簡體中文
只輸出整理後的文字，不要加任何解釋。";
...
3. 使用正式、專業的用語和語氣
4. 修正語法但保持原意
5. 適當加入標點符號，中文內容必須使用全形標點（，、。！？：；「」『』（）——……），絕對不可使用半形標點
6. 所有中文必須使用繁體中文，絕對不可輸出簡體中文
只輸出整理後的文字，不要加任何解釋。";
...
3. 使用正式、專業的用語和語氣
4. 修正語法但保持原意和原本的語言選擇
5. 適當加入標點符號，中文部分必須使用全形標點（，、。！？：；「」『』（）——……），絕對不可使用半形標點
6. 不要把外語強制翻譯成中文
7. 所有中文部分必須使用繁體中文，絕對不可輸出簡體中文
只輸出整理後的文字，不要加任何解釋。";
